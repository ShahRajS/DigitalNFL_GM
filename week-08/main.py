...
# Ensure the week-08 directory is in sys.path to handle all execution context path differences
...
draft_scout = Agent(
    name="Draft_Scout",
    model=model,
    description="A professional scout that queries database stats, browses the web, manages the draft board session state, and utilizes a RAG pipeline for the draft packet.",
    tools=[
...
def main():
    ...
    print("--- Digital NFL GM: System Online (Week 8 Edition - Scalable RAG Model) ---")
